                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.peru.travel/pe/atractivos/machu-picchu">Machu Picchu</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.peru.travel/pe/atractivos/lineas-de-nasca" class="underline text-gray-900 dark:text-white">Lineas de Nasca</a></div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://senati.blackboard.com/" class="ml-1 underline">
                                nuestro sitio
                            </a>
                            ...
                            <a href="https://www.youtube.com/user/virtualsenati" class="ml-1 underline">
                                visitanos
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        Hola Senatinos v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </div>
                </div>
            </div>
        </div>
